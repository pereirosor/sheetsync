...
const tormenta20: GameSystem = {
  ...
  generalPowers: [
    ...
    // Poderes de combate complementares (Complemento – Poderes)
    { name: 'Alcance Ampliado', group: 'Combate', description: 'Ao usar armas alongadas, seu alcance natural é triplicado em vez de duplicado.', prereqs: { raw: 'Treinado em Luta', skillsTrained: ['luta'] } },
    { name: 'Arremessador Veloz', group: 'Combate', description: 'Uma vez por rodada, quando faz um ataque com arma de arremesso, pode gastar 1 PM para fazer um ataque adicional contra o mesmo alvo com outra arma do mesmo tipo.', prereqs: { raw: 'Estilo de Arremesso', powers: ['Estilo de Arremesso'] } },
    { name: 'Ataque com Escudo', group: 'Combate', description: 'Se estiver empunhando um escudo, ao usar a ação atacar, pode gastar 1 PM para fazer um ataque corpo a corpo extra com o escudo sem perder o bônus de escudo na Defesa.', prereqs: { raw: 'Estilo de Arma e Escudo', powers: ['Estilo de Arma e Escudo'] } },
    { name: 'Cavaleiro Invicto', group: 'Combate', description: 'Enquanto estiver montado, sempre que precisar fazer um teste de Reflexos, pode gastar 2 PM para usar Cavalgar no lugar. Se o efeito permitir reduzir dano à metade, você não sofre dano algum ao passar.', prereqs: { raw: 'Combate Montado', powers: ['Ginete'] } },
    { name: 'Corte Profundo', group: 'Combate', description: 'Quando ataca com arma corpo a corpo de corte, pode gastar 1 PM. Se acertar, causa +1d8 pontos de dano.', prereqs: { raw: 'Treinado em Luta', skillsTrained: ['luta'] } },
    { name: 'Decapitar', group: 'Combate', description: 'Com arma de duas mãos de corte ou impacto, gaste ação completa e 5 PM para atacar alvo indefeso. Se acertar, decepa a cabeça da criatura (Fortitude CD For evita). A criatura morre instantaneamente a menos que tenha mais de uma cabeça.', prereqs: { raw: 'For +2, Foco em Arma com a arma utilizada', attributes: { strength: 12 }, powers: ['Foco em Arma'] } },
    { name: 'Escudo Vivo', group: 'Combate', description: 'Se estiver agarrando uma criatura, gaste ação de movimento e 2 PM para usá-la como escudo vivo. Você fica sob cobertura e ataques que errem você por 5 ou mais acertam a criatura usada como escudo.' },
    { name: 'Estocada Penetrante', group: 'Combate', description: 'Quando ataca com arma corpo a corpo de perfuração, pode gastar 1 PM. Se acertar, o alvo sofre –2 nos testes de ataque e nas rolagens de dano até o início da sua próxima rodada.', prereqs: { raw: 'Treinado em Luta', skillsTrained: ['luta'] } },
    { name: 'Golpe Devastador', group: 'Combate', description: 'Gaste ação completa e 4 PM para fazer ataque corpo a corpo com –5. Se acertar, causa dano normal e o alvo faz Fortitude (CD = dano sofrido) ou fica desprevenido e sangrando até receber cura mágica ou teste de Cura CD 20. Apenas armas de corte contra alvos com armadura leve ou nenhuma.', prereqs: { raw: 'Foco em Arma com a arma utilizada', powers: ['Foco em Arma'] } },
    { name: 'Golpe em Ferida', group: 'Combate', description: 'Ao atacar criatura com PV abaixo do total, pode gastar 1 PM e sofrer –5 no ataque. Se acertar, o alvo fica debilitado até o fim de seu próximo turno (Fortitude CD For evita).', prereqs: { raw: 'Foco em Arma com a arma utilizada', powers: ['Foco em Arma'] } },
    { name: 'Persistência', group: 'Combate', description: 'Sempre que erra um ataque contra uma criatura, recebe bônus cumulativo de +2 em testes de ataque contra o mesmo alvo. O bônus zera quando você acerta o alvo ou ataca outro.', prereqs: { raw: 'Treinado em Guerra', skillsTrained: ['guerra'] } },
    // Escolas de combate (Complemento – Poderes)
    { name: 'Escola de Lamnor', group: 'Combate', description: 'Ao usar Mira Apurada com arma de disparo e Foco em Arma, além dos benefícios normais seus ataques ignoram bônus de Defesa por cobertura, reduzem a chance de falha por camuflagem em 20% e ignoram até 5 pontos de RD do alvo.', prereqs: { raw: 'Estilo de Disparo, Foco em Arma (arma de disparo), Mira Apurada', powers: ['Estilo de Disparo', 'Foco em Arma', 'Mira Apurada'] } },
    { name: 'Escola dos Pacificadores', group: 'Combate', description: 'Você recebe +5 em testes para fazer manobras com ataques desarmados. Além disso, não sofre penalidades no ataque quando faz ataque desarmado sob efeito de Combate Defensivo.', prereqs: { raw: 'Ataque Piedoso, Combate Defensivo, Estilo Desarmado', powers: ['Ataque Piedoso', 'Combate Defensivo', 'Estilo Desarmado'] } },
    { name: 'Escola da Legião de Tapista', group: 'Combate', description: 'Sempre que ataca com Ataque com Escudo, pode usar Pancada Estonteante pagando 1 PM (em vez de 2 PM). Além disso, seu bônus de dano de Brecha da Guarda aumenta para +2d6.', prereqs: { raw: 'Ataque com Escudo, Brecha da Guarda, Pancada Estonteante', powers: ['Ataque com Escudo'] } },
    { name: 'Escola dos Duyshidakk', group: 'Combate', description: 'Você aumenta em um passo o dano de ataques desarmados no primeiro turno de um combate. Além disso, recebe +5 em ataques contra oponentes vulneráveis, caídos ou sob efeito de medo.', prereqs: { raw: 'Treinado em Iniciativa, Estilo Desarmado, Presença Aterradora, Reflexos de Combate', powers: ['Estilo Desarmado', 'Presença Aterradora', 'Reflexos de Combate'], skillsTrained: ['iniciativa'] } },
    { name: 'Escola de Doherimm', group: 'Combate', description: 'Escola de combate desarmado anão. Seus ataques desarmados têm dano aumentado em um passo e você pode usar Luta para manobras agarrar e derrubar sem sofrer penalidades por não usar arma.', prereqs: { raw: 'Estilo Desarmado, 6º nível de personagem', powers: ['Estilo Desarmado'], minLevel: 6 } },
    // ── Destino ───────────────────────────────────────────────────────────
    ...
    // Poderes de magia complementares (Complemento – Poderes)
    { name: 'Aprimoramento Ácido', group: 'Magia', description: 'Suas magias que causam dano de ácido recebem um novo aprimoramento: +1 PM — além do normal, a magia exala gases nocivos e um alvo que falhe no teste de resistência fica enjoado por uma rodada.', prereqs: { raw: 'Lançar magias que causem dano de ácido', other: ['Habilidade de classe Magias'] } },
    { name: 'Aprimoramento Elétrico', group: 'Magia', description: 'Suas magias que causam dano de eletricidade recebem um novo aprimoramento: +1 PM — além do normal, a magia irrompe em trovão retumbante e um alvo que falhe no teste de resistência fica caído por uma rodada.', prereqs: { raw: 'Lançar magias que causem dano elétrico', other: ['Habilidade de classe Magias'] } },
    { name: 'Aprimoramento Glacial', group: 'Magia', description: 'Suas magias que causam dano de frio recebem um novo aprimoramento: +1 PM — além do normal, a magia cobre os alvos com cristais de gelo e um alvo que falhe no teste de resistência fica enredado por uma rodada.', prereqs: { raw: 'Lançar magias que causem dano de frio', other: ['Habilidade de classe Magias'] } },
    { name: 'Aprimoramento Ígneo', group: 'Magia', description: 'Suas magias que causam dano de fogo recebem um novo aprimoramento: +1 PM — além do normal, as chamas emitem brilho intenso e um alvo que falhe no teste de resistência fica cego por uma rodada.', prereqs: { raw: 'Lançar magias que causem dano de fogo', other: ['Habilidade de classe Magias'] } },
    { name: 'Aprimoramento Elemental', group: 'Magia', description: 'Escolha um tipo de dano (ácido, eletricidade, frio ou fogo). Suas magias desse tipo recebem: +3 PM — cria 1d4 (+1 por círculo) elementais Pequenos do tipo correspondente que persistem até o fim da cena ou a 0 PV.', prereqs: { raw: 'Lançar magias de 3º círculo', other: ['Lançar magias de 3º círculo'] } },
    { name: 'Arma das Sombras', group: 'Magia', description: 'Gaste 1 PM para imbuir uma arma empunhada com energia sombria até o fim da cena. A arma causa +2 de dano de trevas. Cada vez que você reduz um inimigo a 0 PV, o bônus aumenta em +1 (máximo limitado por Força). Habilidade mágica.', prereqs: { raw: 'Lançar magias', other: ['Habilidade de classe Magias'] } },
    { name: 'Aura Belicosa', group: 'Magia', description: 'Gaste 2 PM para gerar uma aura belicosa com 9m de raio que dura até o fim da cena. Cada criatura que entrar ou iniciar o turno nela deve fazer Vontade (CD Car) ou atacar a criatura mais próxima com quem tiver atitude mais baixa. Imune por um dia se passar. Habilidade mágica.', prereqs: { raw: 'Car 13, Lançar magias', attributes: { charisma: 13 }, other: ['Habilidade de classe Magias'] } },
    { name: 'Extrato Alquímico', group: 'Magia', description: 'Se tiver acesso ao corpo de uma criatura recém-abatida (menos de 2h), pode fazer teste de Sobrevivência ou Misticismo (CD 12 + ND) para extrair substratos alquímicos, reduzindo o custo de fabricação de poções em 1 PM por cada 2 ND da criatura.', prereqs: { raw: 'Preparar Poção, 4º nível de personagem', powers: ['Preparar Poção'], minLevel: 4 } },
    { name: 'Receita Mágica', group: 'Magia', description: 'Você pode preparar uma receita mágica com custo igual ao círculo ao quadrado × T$25. Pode alimentar até 4 criaturas médias que recebem os efeitos de uma magia, mas deve ser consumida imediatamente e não pode ser armazenada.', prereqs: { raw: 'Preparar Poção, 6º nível de personagem', powers: ['Preparar Poção'], minLevel: 6 } },
    // ── Concedidos ────────────────────────────────────────────────────────
  ...
  // Magias complementares (Complemento – Magias)
  'Açoite de Chamas': {
    spellType: 'arcana',
    circle: 1,
    school: 'Convocação',
    castingTime: 'padrão',
    range: 'pessoal',
    target: 'açoite de chamas criado em sua mão',
    duration: 'sustentada',
    resistance: 'Reflexos especial',
    description: 'Um açoite de fogo surge em uma de suas mãos (essa mão fica ocupada durante a duração). Você pode usar uma ação padrão para causar 2d6 pontos de dano de fogo em uma criatura em alcance curto e deixá-la em chamas e enredada enquanto estiver em chamas. Passar na resistência reduz o dano à metade e evita as condições.',
    amplifications: [
      { cost: 2, effect: 'muda a execução para movimento' },
      { cost: 2, effect: 'muda o dano para 4d6. Requer 2° círculo' },
      { cost: 5, effect: 'muda o dano para 6d6. Requer 3° círculo' },
    ],
  },
  'Armar': {
    spellType: 'universal',
    ...
    duration: 'cena',
    description: 'A arma é considerada mágica e fornece +1 nos testes de ataque e rolagens de dano (conta como bônus de encanto). Se você estiver empunhando a arma, pode usar seu atributo-chave de magias em vez do atributo original nos testes de ataque.',
    amplifications: [
      { cost: 2, effect: 'aumenta o bônus em +1 (máximo limitado pelo círculo máximo que você pode lançar)' },
      { cost: 2, effect: 'a arma causa +1d6 de dano de ácido, eletricidade, fogo ou frio, escolhido ao lançar. Apenas uma vez' },
      { cost: 3, effect: 'muda o bônus de dano do aprimoramento acima para +2d6' },
    ],
  },
  'Aura de Tormenta': {
    spellType: 'universal',
    ...
    duration: 'sustentada',
    resistance: 'veja texto',
    description: 'Uma nuvem rubra surge acima do conjurador. Uma vez por turno, você pode gastar uma ação de movimento para manifestar um dos fenômenos: Chuva ácida (6d4 de ácido na área); Neblina venenosa (2d12 de veneno, Fortitude evita); Raios escarlates (6d8 de eletricidade em até 6 inimigos, Reflexos reduz); Pesadelos reais (4d6 psíquico + 1d4 PM, Vontade reduz e evita PM). Apenas conjuradores que já observaram uma área de Tormenta.',
    amplifications: [
      { cost: 3, effect: 'aumenta o dano em +1 dado do mesmo tipo' },
      { cost: 5, effect: 'criaturas na área ficam alquebradas enquanto permanecerem nela' },
      { cost: 5, effect: 'muda a área para círculo de 1km de raio. Apenas Devotos de Aharadak' },
    ],
  },
  'Bala de Neve': {
    spellType: 'arcana',
    ...
    amplifications: [
      { cost: 1, effect: 'aumenta o dano em +1d8+1' },
      { cost: 1, effect: 'muda a resistência para Fortitude parcial. Se passar, reduz à metade; se falhar, fica lenta até o final da cena' },
    ],
  },
  'Capangas Esqueletos': {
    spellType: 'universal',
    ...
    duration: 'sustentada',
    description: 'Você conjura seis esqueletos capangas tamanho Médio em espaços desocupados dentro do alcance. Use ação de movimento para movê-los (deslocamento 9m) ou ação padrão para fazê-los causar 1d6+2 de trevas a criaturas adjacentes. Têm For 2, Des 2, Defesa 18, 1 PV e imunidade a várias condições. Desaparecem a 0 PV ou no fim da cena.',
    amplifications: [
      { cost: 2, effect: 'aumenta o número de mortos-vivos em +1' },
      { cost: 3, effect: 'em vez de esqueletos, conjura carniçais (For 3, Des 3, Defesa 27, 1d8+3 trevas + veneno, paralisia). Requer 3° círculo' },
      { cost: 3, effect: 'em vez de esqueletos, conjura fúrias de Tauron (voo 12m, incorpóreo, 1d6 trevas + 1d6 fogo, deixa desprevenido). Requer 3° círculo' },
      { cost: 7, effect: 'em vez de esqueletos, conjura sombras (incorpóreo, 2d10 trevas, drena 1d4 PM em falha). Requer 4° círculo' },
    ],
  },
  'Controle de Ar': {
    spellType: 'divina',
    ...
    duration: 'cena',
    resistance: 'veja texto',
    description: 'Você controla movimentos e comportamentos de massas de ar. Escolha um efeito: Ascender (ergue criatura ou objeto médio, vulnerável, Fort nega); Corrente (manobra derrubar em criatura voadora); Sopro (empurra criaturas Médias ou menores em cone de 4,5m); Vento (cria área de vento forte dentro do alcance).',
    amplifications: [
      { cost: 2, effect: 'aumenta o limite de tamanho de criaturas e objetos afetados em um passo' },
    ],
  },
  'Convocar Equipamento': {
    spellType: 'universal',
    circle: 2,
    school: 'Convocação',
    castingTime: 'padrão',
    range: 'toque',
    target: 'até dois itens seus (armas, armaduras ou escudos)',
    duration: 'permanente até ser descarregada',
    description: 'A magia é lançada sobre até dois itens que você possua. Após isso, pode usar uma ação completa para convocar os itens, que aparecem sobre seu corpo e em suas mãos. Funciona independentemente da distância, mas termina se perder a posse dos itens. O efeito é espalhafatoso.',
    amplifications: [
      { cost: 1, effect: 'aumenta o número de alvos em dois e o custo adicional em +1 PM' },
    ],
  },
  'Dardo de Gelo': {
    spellType: 'arcana',
    ...
    duration: 'instantânea',
    resistance: 'Fortitude parcial',
    description: 'Você dispara um dardo de gelo contra o alvo, que sofre 2d6 pontos de dano de frio e fica lento por 1 rodada. Passar no teste reduz o dano à metade e evita a condição.',
    amplifications: [
      { cost: 1, effect: 'aumenta o dano em +1d6' },
      { cost: 1, effect: 'aumenta o número de alvos em +1 (total limitado pelo círculo máximo)' },
    ],
  },
  'Elemental Familiar': {
    spellType: 'arcana',
    ...
    castingTime: 'completa',
    range: 'curto',
    target: 'familiar elemental',
    duration: 'sustentada',
    description: 'Você transforma uma porção de um elemento inerte em uma criatura elemental Pequena do tipo do elemento. Pode criar elementais do ar, água, fogo e terra. O elemental obedece a todos os comandos e funciona como um familiar comum ou elemental. Não conta no limite de parceiros.',
    amplifications: [
      { cost: 1, effect: 'além do normal, o elemental fornece redução 10 contra o dano de seu tipo' },
      { cost: 2, effect: 'em vez do normal, o elemental recebe a habilidade de dois familiares (um comum e um elemental)' },
    ],
  },
  'Explosão Ácida': {
    spellType: 'arcana',
    ...
    castingTime: 'padrão',
    range: 'médio',
    target: 'cilindro com 3m de diâmetro e 3m de altura',
    duration: 'instantânea',
    resistance: 'Reflexos reduz à metade',
    description: 'O solo explode em ácido corrosivo, causando 2d6 pontos de dano de ácido em todas as criaturas e objetos livres na área.',
    amplifications: [
      { cost: 1, effect: 'aumenta o dano em +1d6' },
      { cost: 2, effect: 'além do normal, o solo continua borbulhando em ácido até o final da cena, tornando-se terreno difícil. Qualquer criatura que entre ou comece o turno dentro sofre 2d6 de ácido' },
    ],
  },
  'Forma Dracônica': {
    spellType: 'arcana',
    ...
    target: 'você',
    duration: 'sustentada',
    description: 'Você recebe +2 em Força, Constituição, Inteligência e Carisma, +5 na Defesa e redução 30 ao elemento do dragão do componente material. Uma vez por rodada, pode usar ação padrão para exalar sopro de 8d6+8 de dano em cone de 9m (Reflexos reduz à metade).',
    amplifications: [
      { cost: 2, effect: 'aumenta o dano do sopro em +1d6+1' },
      { cost: 2, effect: 'aumenta o bônus na Defesa em +1' },
      { cost: 3, effect: 'o bônus em atributos se torna +4' },
      { cost: 3, effect: 'você recebe mordida (1d6, x2, corte) como arma natural, podendo usá-la como ataque extra por 1 PM' },
      { cost: 6, effect: 'além do normal, asas brotam de suas costas e você recebe deslocamento de voo 18m' },
    ],
  },
  'Forma de Relâmpago': {
    spellType: 'arcana',
    ...
    duration: 'sustentada',
    resistance: 'Reflexos reduz à metade',
    description: 'Seus olhos emanam luz branca e raios elétricos. Enquanto a magia durar, pode usar ação de movimento para se teletransportar até 12m em linha reta. Criaturas que você atravessar sofrem 6d8 de dano elétrico.',
    amplifications: [
      { cost: 2, effect: 'aumenta o dano em +2d8' },
      { cost: 5, effect: 'muda o teletransporte para 15m e você pode fazer curvas (sem passar pelo mesmo espaço duas vezes)' },
    ],
  },
  'Forma Glacial': {
    spellType: 'universal',
    ...
    target: 'você',
    duration: 'sustentada',
    description: 'Sua pele torna-se branca como neve e você manifesta asas e coroa de gelo cristalino. Você recebe deslocamento de voo 18m, imunidade a fogo e frio e resistência a dano não mágico 15. Suas magias de frio têm dano maximizado, mas você fica impedido de lançar magias de fogo.',
    amplifications: [],
  },
  'Jato Ácido': {
    spellType: 'arcana',
    ...
    duration: 'instantânea',
    resistance: 'Fortitude reduz à metade',
    description: 'Você dispara um jato de ácido corrosivo das mãos, causando 2d6 pontos de dano de ácido às criaturas na linha. Causa dano dobrado em construtos e objetos.',
    amplifications: [
      { cost: 1, effect: 'aumenta o dano em +1d6' },
      { cost: 1, effect: 'muda a resistência para Fortitude parcial: se passar reduz à metade; se falhar fica vulnerável' },
    ],
  },
  'Nuvem Corrosiva': {
    spellType: 'universal',
    ...
    duration: 'instantânea',
    resistance: 'Fortitude parcial',
    description: 'Você sopra fumaça esverdeada de toxinas corrosivas. Criaturas na área sofrem 4d8 de dano de ácido mais 4d8 de dano de veneno e ficam cegas por 1d4+1 rodadas. Fortitude reduz o dano à metade e evita a cegueira.',
    amplifications: [
      { cost: 2, effect: 'aumenta o dano de ácido em +1d8 e o de veneno em +1d8' },
    ],
  },
  'Nuvem Elétrica': {
    spellType: 'arcana',
    ...
    castingTime: 'padrão',
    range: 'curto',
    target: 'nuvem com 3m de diâmetro',
    duration: 'sustentada',
    resistance: 'Fortitude reduz à metade',
    description: 'Você cria uma nuvem espessa carregada com eletricidade que causa 2d8 de dano elétrico a criaturas no mesmo espaço. Use ação de movimento para mover a nuvem 6m em qualquer direção. Uma criatura só sofre dano uma vez por rodada. A nuvem é imune a dano e conta como criatura Pequena para efeitos de vento.',
    amplifications: [
      { cost: 1, effect: 'aumenta o dano em +1d8' },
      { cost: 2, effect: 'a nuvem retumba com trovões. Criaturas que falharem ficam atordoadas por 1 rodada (imunes se passarem)' },
    ],
  },
  'Pântano Ácido': {
    spellType: 'arcana',
    ...
    castingTime: 'padrão',
    range: 'médio',
    target: 'círculo de 15m de raio',
    duration: 'cena',
    resistance: 'Reflexos reduz à metade',
    description: 'O solo da área vira lodo viscoso ácido. Criaturas na área sofrem 5d8 de ácido e ficam enredadas (Reflexos reduz e evita enredar). Presas podem se libertar com Atletismo CD da magia (ação padrão). Criaturas que terminam o turno na área sofrem o efeito novamente. O espaço é terreno difícil; mover 1,5m causa 1d8 de ácido.',
    amplifications: [
      { cost: 2, effect: 'aumenta o dano inicial e o dano de deslocamento em +1d8' },
      { cost: 5, effect: 'criaturas que falharem ficam confusas por uma rodada (efeito alucinógeno)' },
    ],
  },
  'Raio de Plasma': {
    spellType: 'arcana',
    ...
    duration: 'instantânea',
    resistance: 'Fortitude reduz à metade',
    description: 'Você dispara uma rajada luminosa superaquecida causando 10d8 de dano de fogo em criaturas e objetos na área. O raio pode derreter barreiras físicas de madeira, pedra ou metal, atingindo alvos fora da linha de visão.',
    amplifications: [
      { cost: 2, effect: 'aumenta o dano em +2d8' },
      { cost: 2, effect: 'muda para espada de plasma (alcance curto, sustentada): ação padrão causa 10d8 de fogo e ignora RD' },
    ],
  },
  'Raio Estrondoso': {
    spellType: 'arcana',
    ...
    duration: 'sustentada',
    resistance: 'Fortitude parcial',
    description: 'Um relâmpago poderoso acerta o alvo. Ele sofre 4d6 de dano elétrico mais 4d6 de dano de impacto e fica caído e atordoado por uma rodada. Se passar, sofre metade do dano, evita as condições e não pode mais ser atordoado por esta magia na cena.',
    amplifications: [
      { cost: 2, effect: 'aumenta o dano de eletricidade em +1d6 e o de impacto em +1d6' },
    ],
  },
  'Tempestade de Gelo': {
    spellType: 'arcana',
    ...
    duration: 'instantânea',
    resistance: 'Fortitude parcial',
    description: 'Você emite uma onda de frio extremo que cobre a área de gelo. Criaturas sofrem 2d6 de dano de frio e ficam enredadas e imóveis por 1d4 rodadas. Fortitude reduz à metade e deixa apenas enredada por uma rodada. Uma criatura voadora que fica imóvel começa a cair no início de seu turno.',
    amplifications: [
      { cost: 1, effect: 'aumenta o dano em +1d6' },
      { cost: 2, effect: 'muda a duração para sustentada: criaturas que entrem ou iniciem o turno na área sofrem 2d6 de frio e ficam enredadas/imóveis. Requer 2° círculo' },
    ],
  },
  'Toque de Gelo': {
    spellType: 'arcana',
    ...
    duration: 'instantânea',
    resistance: 'Fortitude parcial',
    description: 'Sua mão emite energia congelante causando 6d8 de dano de frio e recobre o alvo com uma camada de gelo, deixando-o paralisado por 1d4 rodadas. O alvo pode refazer o teste de Fortitude no final de seus turnos para se livrar. Fortitude reduz à metade e deixa apenas enredado por uma rodada.',
    amplifications: [
      { cost: 1, effect: 'como parte da execução, pode fazer ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e da magia' },
      { cost: 2, effect: 'aumenta o dano em +2d8' },
    ],
  },
  },
